...
sed '1,5d' fort.8 > temporary 
sed '1d' temporary > $1.normal
rm -rf fort.8 fort.7 temporary
sed '1d' $1.center > tmpfile
mv tmpfile $1.text
rm -rf tmpfile

grep -w ATOM < $2 > $2.inpu
...
sed '1,5d' fort.8 > temporary
sed '1d' temporary > $2.normal 
rm -rf fort.7 fort.8 temporary
cat $1.normal $2.normal >> complex.normal 
sed '1d' $2.center > tmpfile
mv tmpfile $2.text
rm -rf $2.center tmpfile $1.normal $2.normal 

cat $1.text $2.text >> $1+$2.centre 
rm -f $1.text $2.text 

cat $1 $2 >> comp.pdb
grep -w ATOM < comp.pdb > pomc.pdb
rm -rf comp.pdb
